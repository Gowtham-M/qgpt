...
from everi_ai_qgpt_core.server.chat.chat_service import ChatService, CompletionGen
from everi_ai_qgpt_core.server.chunks.chunks_service import Chunk, ChunksService
from everi_ai_qgpt_core.server.ingest.ingest_service import IngestService
from everi_ai_qgpt_core.server.recipes.summarize.summarize_service import SummarizeService
from everi_ai_qgpt_core.settings.settings import settings
from everi_ai_qgpt_core.ui.images import logo_svg
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            with gr.Row():
                ...
                gr.HTML(
                    f"<div class='footer'><a class='footer-zylon-link' href='https://www.everi.com/'> Made at Everi. ©2025 Everi Payments Inc. <img class='footer-zylon-ico' src='{f_base64}' alt=Zylon></a></div>"
                )
